    ...
    <div class="container" data-aos="fade-up">
        <div class="row gx-0">
            ...
            <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                <img src="{{ asset('fe_assets/img/11.jpg') }}" class="img-fluid" style="max-width: 530px;" alt="">
            </div>
        ...
        <div class="row gy-4 aos-init" data-aos="fade-left">
            ...
            @foreach($produkBaru as $produk)
                <div class="col-lg-3 col-md-6 aos-init" data-aos="zoom-in" data-aos-delay="100">
                    <div class="box">
                        <a href="/produk-detail/{{$produk->slug}}"> <h3 style="color: #919191; font-size:16px"> {{$produk->nama_produk}}</h3>

                        <img src="{{ asset('gambar/'.$produk->gambar_utama) }}" class="img-fluid" style=" max-height:200px; min-height:200px; max-width:100%;" alt="">
                        </a>
                        <ul>
        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="300">
                <div class="service-box orange">
                    <p><img class="img-fluid" style="height: 100px;" src="{{ asset('fe_assets/img/rekom.png') }}"></p>
                    <h3>Terpercaya</h3>
                    <p>&nbsp;</p>
                    <!-- <a href="#" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a> -->
                </div>
            ...
            <div class="col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-delay="400">
                <div class="service-box green">
                    <p><img class="img-fluid" style="height: 100px;" src="{{ asset('fe_assets/img/bukti.png') }}"></p>
                    ...
                    <div class="row mcb-wrap-inner">
                        ...
                        <div class="col-md-4 column mcb-column one-third column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                <img class="m-3" src="/fe_assets/img/why/Garansi-kualitas.png" alt="heart" width="75"
                                    height="75">
                                <br>
                        ...
                        <div class="col-md-4 column mcb-column one-third column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                <img class="m-3" src="/fe_assets/img/why/garansi-tukar-baru.png" alt="heart" width="75"
                                    height="75">
                                <br>
                                <h5><strong>GARANSI TUKAR BARU</strong></h5>
                                <p style="text-align: center;">{{website()->nama_website}} memberikan garansi tukar baru
                        ...
                        <div class="col-md-4 column mcb-column one-third column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                ...
                                <p style="text-align: center;">{{website()->nama_website}} memberikan Harga Terbaik, silahkan
                                    berdiskusi dengan
                        ...
                        <div class="col-md-4 column mcb-column one-third column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                ...
                                <img class="m-3" src="/fe_assets/img/why/produksi-besar.png" alt="heart" width="75"
                                    height="75"><br>
                        ...
                        <div class="col-md-4 column mcb-column one-third column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                ...
                                <img class="m-3" src="/fe_assets/img/why/Gratis-jasa-desain.png" alt="heart" width="75"
                                    height="75"><br>
                        ...
                        <div class="col-md-4 column mcb-column one-third column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                ...
                                <img class="m-3" src="/fe_assets/img/why/berpengalaman.png" alt="heart" width="75"
                                    height="75"><br>
                                <h5><strong>Berpengalaman Dan LEGALITAS Resmi</strong></h5>
                                <p style="text-align: center;">{{website()->nama_website}} merupakan perusahaan berbadan hukum
                        ...
                        <div class="col-md-4 column mcb-column one-third column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                ...
                                <img class="m-3" src="/fe_assets/img/why/order-mudah.png" alt="heart" width="75"
                                    height="75"><br>
                                <h5><strong>Proses Order Mudah &amp; Cepat Respon </strong></h5>
                                <p style="text-align: center;">{{website()->nama_website}} memberikan kemudahan dalam proses
                        ...
                        <div class="col-md-4 column mcb-column one-third column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                ...
                                <img class="m-3" src="/fe_assets/img/why/gratis-biaya-kirim.png" alt="heart" width="75"
                                    height="75"><br>
                        ...
                        <div class="col-md-4 column mcb-column one column_column  column-margin-">
                            <div class="column_attr clearfix align_center" style="text-align:center">
                                ...
                                <img class="m-3" src="/fe_assets/img/why/gratis-souvenir.png" alt="heart" width="75"
                                    height="75"><br>
                                <h5><strong>Gratis Souvenir Eksklusif</strong></h5>
                                <p style="text-align: center;">Setiap pemesanan di {{website()->nama_website}} akan mendapatkan
                                    Souvenir Eksklusif
                                    secara gratis</p>
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="clients-slider swiper">
            <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide"><img src="{{ asset('fe_assets/img/c1.jpg') }}" class="img-fluid" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('fe_assets/img/c2.jpg') }}" class="img-fluid" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('fe_assets/img/c3.jpg') }}" class="img-fluid" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('fe_assets/img/c4.jpg') }}" class="img-fluid" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('fe_assets/img/c5.jpg') }}" class="img-fluid" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('fe_assets/img/c6.jpg') }}" class="img-fluid" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('fe_assets/img/c7.jpg') }}" class="img-fluid" alt=""></div>
                <div class="swiper-slide"><img src="{{ asset('fe_assets/img/c8.jpg') }}" class="img-fluid" alt=""></div>
            </div>
...
<div class="container" data-aos="fade-up">
  ...
  <div class="row">
    ...
    <div class="col-lg-4">
      <div class="post-box">
        <div class="post-img"><img src="{{ asset('postImage/'.$recent->cover) }}" class="img-fluid" style="max-height: 150px" alt=""></div>
        <span class="post-date">{{ Carbon\Carbon::parse($recent->created_at)->diffForHumans()}}</span>
        <h3 class="post-title">{{$recent->title}}</h3>
        <a href="{{ route('show', $recent->slug) }}" class="readmore stretched-link mt-auto"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
      </div>
    </div>
    @endforeach
