                    ...
                    <div class="col-xl-12 col-md-12">
                        ...
                        <div id="cartElement">
                            ...
                            @foreach ($cartItems as $index => $item)
                                <?php
                                array_push($totalBerat, \App\Models\Produk::where('id', $item->id)->first()->berat * $item->quantity);
                                array_push($totalHargaBarang, \App\Models\Produk::where('id', $item->id)->first()->harga_jual * $item->quantity);
                                ?>
                                <div class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
                                    <div class="media d-block d-sm-flex text-center text-sm-left">
                                        <a class="cart-item-thumb mx-auto mr-sm-4" href="javascript:void(0);"><img
                                                src="/gambar/{{ \App\Models\Produk::where('id', $item->id)->first()->gambar_utama }}"
                                                alt="Product"></a>
                                        ...
                                        <div class="order-total table-responsive ">
                                            <table class="table table-borderless text-right">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Harga product :</td>
                                                        <td><span>Rp.{{ number_format(array_sum($totalHargaBarang), 0, ',', '.') }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
