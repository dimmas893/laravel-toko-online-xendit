                    ...
                    <div class="print">
                        ...
                        <div class="card-body">
                            <div class="row">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <?php
                                                                    $status=$transaksi->status_trans;
                                                                    if($status==1){
                                                                        echo "<p class='text-warning'>Menunggu Verifikasi</p>";
                                                                    }elseif($status==2){
                                ...
                                <div class="col-sm-4">
                                    <span class="text-left">Scan Untuk Melihat Detail</span><br>
                                    {!! QrCode::size(80)->generate(url('transaksi').'/'.$transaksi->id) !!}
